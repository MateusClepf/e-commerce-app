...
const HomePage = () => {
  ...
  const categories = [
    { name: 'Electronics', icon: '🖥️', bgColor: 'bg-blue-100' },
    { name: 'Clothing', icon: '👕', bgColor: 'bg-green-100' },
    { name: 'Footwear', icon: '👟', bgColor: 'bg-yellow-100' },
    { name: 'Home', icon: '🏠', bgColor: 'bg-red-100' },
    { name: 'Accessories', icon: '👜', bgColor: 'bg-purple-100' },
    { name: 'Books', icon: '📚', bgColor: 'bg-indigo-100' },
  ];
              ...
              <div className="flex flex-col lg:flex-row items-center">
                <div className="lg:w-1/2 p-8 lg:p-12">
                  ...
                  >
                    ...
                    <Link to="/products?sale=true" className="btn bg-white text-primary hover:bg-white/90 px-8 py-3">
                      Shop the Sale
                    </Link>
                  </motion.div>
                </div>
              ...
              <div className="flex flex-col-reverse lg:flex-row items-center">
                ...
                <div className="lg:w-1/2 p-8 lg:p-12">
                  ...
                  >
                    ...
                    <Link to="/products?new=true" className="btn btn-primary px-8 py-3">
                      Explore New Items
                    </Link>
                  </motion.div>
                </div>
